...
(function() {
    ...
    var endpointSelector = new DevExpress.EndpointSelector(DevTest.config.endpoints);
    var serviceConfig = $.extend(true, {}, DevTest.config.services, {
        db: {
    ...
    DevTest.db = new DevExpress.data.ODataContext(serviceConfig.db);
